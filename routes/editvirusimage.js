...
router.get('/deletevirusimage/:virusId/:imageNumber', function(request, response) {
    ...
    async function deleteImage() {
        ...
        response.write(`<a href="`+config.webbadress+`/api/editvirus/${virusId}" style="display:inline-block; margin-top:20px; padding:10px 20px; background-color:#007BFF; color:#fff; text-decoration:none; border-radius:5px;">Back to Edit Virus</a>`);
